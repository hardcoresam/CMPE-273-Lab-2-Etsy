...
export default function UserProfile(props) {
    ...
    useEffect(async () => {
        ...
        setUserProfileForm(prevState => {
            ...
            userProfileForm.city = member.city;
            ...
            userProfileForm.country = member.country;
            userProfileForm.streetAddress = member.street_address;
            userProfileForm.aptNo = member.apt_no;
            userProfileForm.zipCode = member.zipcode;
            userProfileForm.state = member.state;
            userProfileForm.country = member.country;
